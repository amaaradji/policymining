...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{results/availability_violation_detection_results_gt2.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{results/violations_by_resource_gt2.png}
